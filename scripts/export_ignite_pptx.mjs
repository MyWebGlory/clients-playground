...
function addPageOne() {
  ...
  text(slide, 'IGNITE is a premium, hands-on development experience. Led by seasoned life sciences industry leaders and coaching experts who speak from lived experience, this program moves far beyond theory: It utilizes immersive, gamified workshops, high-stakes live role-play, and challenging coaching to master public speaking and build a definitive professional leadership signature.', 0.5, 3.52, 4.36, 1.22, { fontSize: 9.7, bold: true, color: C.muted });
